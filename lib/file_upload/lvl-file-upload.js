angular
    ...
    .directive('lvlFileUpload', ['uuid', 'fileUploader', 'fireFactory', function(uuid, fileUploader, fireFactory) {
        return {
            restrict: 'E',
            replace: true,
            scope: {
            ...
            '<label class="label label-default" ng-click="choose()">{{chooseFileButtonText}}</label>' +
            ...
            compile: function compile(tElement, tAttrs, transclude) {
                ...
                return function postLink(scope, el, attrs, ctl) {
                    ...
                    scope.upload = function() {
                        ...
                        fireFactory.addRugImage(scope.files, scope.$root.contactId);
